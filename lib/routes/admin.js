...
router.get('/dashboard', authorize_1.authorize, authorize_1.noCache, admincontroller_1.getAdminDashboard);
router.get('/logout', authorize_1.authorize, admincontroller_1.logout);
...
router.delete('/categories/remove-cat/:id', authorize_1.authorize, categorycontroller_1.removeCategory);
