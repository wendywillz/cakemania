...
const signupSchema = zod_1.z.object({
    ...
    passwordConfirm: zod_1.z.string().nullish(),
    phoneNo: zod_1.z
        .string({
...
const cakeSchema = zod_1.z.object({
    ...
    price: zod_1.z.string().refine(value => {
    ...
    cakeID: zod_1.z.number().nullish(),
    userID: zod_1.z.string().nullish(),
    rating: zod_1.z.number().min(1).max(5, 'rating cannot exceed 5').nullish(),
    comments: zod_1.z.string().min(10).nullish(),
    numReviews: zod_1.z.number().nullish()
});
...
exports.default = { signupSchema, loginSchema, cakeSchema, categorySchema, orderItemsSchema, orderSchema };
// userAddress: z
// .string({
