...
exports.getUserOrders = exports.getOrdersPage = exports.deleteUser = exports.editUser = exports.getEditUser = exports.getUserDashboard = exports.logout = exports.login = exports.signup = void 0;
...
;
function getOrdersPage(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // res.json({ status: "successful", message: "welcome customer"})
